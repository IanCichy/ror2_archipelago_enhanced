...
namespace Archipelago.RiskOfRain2.Handlers
{
    class LocationHandler : IHandler
    {
        ...
        public const int village = 48;          // Shattered Abodes
        public const int villagenight = 49;     // Disturbed Impact - Alternate stage to Shattered Abodes
        public const int lakesnight = 50;       // Viscous Falls - Alternate stage to Verdant Falls
        public const int lemuriantemple = 51;   // Reformed Altar
        public const int habitat = 52;          // Treeborn Colony
        public const int habitatfall = 53;      // Golden Dieback - Alternate stage to Treeborn Colony
        public const int helminthroost = 54;    // Helminth Hatchery
        public const int meridian = 55;         // Prime Meridian
        // Alloyed Collective
        ...
        private void InitialSetupLocationDict(LocationInformationTemplate locationstemplate)
        {
            ...
            currentlocations.Add(solutionalhaunt,   locationstemplate); // Solutional Haunt
