...
namespace Archipelago.RiskOfRain2
{
    ...
    public class ArchipelagoPlugin : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            NetworkingAPI.RegisterMessageType<SyncLootPoolConfig>();
            NetworkingAPI.RegisterMessageType<SyncLootPoolExpansion>();
            NetworkingAPI.RegisterMessageType<SyncSkillConfig>();
            NetworkingAPI.RegisterMessageType<SyncSkillUnlock>();
            NetworkingAPI.RegisterMessageType<SyncSurvivorConfig>();
            NetworkingAPI.RegisterMessageType<SyncSurvivorUnlock>();
