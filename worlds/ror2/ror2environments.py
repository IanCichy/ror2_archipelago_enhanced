...
# DLC2 - Seekers of the Storm (SOTS)
...
environment_sots_orderedstages_table = \
    [environment_sots_orderedstage_1_table, environment_sots_orderedstage_2_table,
     environment_sots_orderedstage_3_table, environment_sots_orderedstage_4_table,
     environment_sots_orderedstage_5_table]
...
environment_ac_orderedstages_table = \
    [environment_ac_orderedstage_1_table, environment_ac_orderedstage_2_table,
     environment_ac_orderedstage_3_table, environment_ac_orderedstage_4_table,
     environment_ac_orderedstage_5_table]
...
environment_non_orderedstages_table = \
    {**environment_vanilla_hidden_realm_table, **environment_vanilla_special_table,
     **environment_sotv_special_table, **environment_sots_special_table, **environment_ac_special_table}
environment_orderedstages_table = \
    collapse_dict_list_vertical(environment_vanilla_orderedstages_table, environment_sotv_orderedstages_table,
                                environment_sots_orderedstages_table, environment_ac_orderedstages_table)
environment_all_table = {**environment_vanilla_table, **environment_sotv_table,
                         **environment_sots_table, **environment_ac_table}
